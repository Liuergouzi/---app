...
public interface StatusAction {
    ...
    default void showEmpty() {
        showLayout(R.drawable.ic_status_empty, R.string.status_layout_no_data, null);
    }
    ...
    default void showError(StatusLayout.OnRetryListener listener) {
        ...
        if (manager != null) {
            ...
            if (info == null || !info.isConnected()) {
                showLayout(R.drawable.ic_status_network, R.string.status_layout_error_network, listener);
                return;
            }
        }
        showLayout(R.drawable.ic_status_error, R.string.status_layout_error_request, listener);
    }

 ...
 *    desc   : 导航栏适配器
 */
public final class MainAdapter extends AppAdapter<MainAdapter.MenuItem>
    ...
    private final class ViewHolder extends AppAdapter<?>.ViewHolder {
        ...
        private ViewHolder() {
            super(R.layout.main_activity_item);
            mIconView = findViewById(R.id.main_navigation_icon);
            mTitleView = findViewById(R.id.main_navigation_title);
        }

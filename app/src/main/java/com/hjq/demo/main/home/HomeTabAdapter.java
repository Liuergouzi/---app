 ...
 *    desc   : Tab 适配器
 */
public final class HomeTabAdapter extends AppAdapter<String> implements BaseAdapter.OnItemClickListener {
    ...
    public HomeTabAdapter(Context context, int tabMode, boolean fixed) {
        super(context);
        mTabMode = tabMode;
        mFixed = fixed;
    ...
    private final class DesignViewHolder extends ViewHolder {

        private final TextView mTitleView;
        private final View mLineView;

        private DesignViewHolder() {
            super(R.layout.home_tab_item_design);
    ...
    private final class SlidingViewHolder extends ViewHolder
        ...
        private SlidingViewHolder() {
            super(R.layout.home_tab_item_sliding);

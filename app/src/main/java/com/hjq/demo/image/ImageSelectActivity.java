...
import com.hjq.demo.dialog.AlbumDialog;
    ...
    protected void onRestart() {
        ...
        while (iterator.hasNext()) {
            ...
            if (mSelectImage.isEmpty()) {
                mFloatingView.setImageResource(R.drawable.ic_camera);
            } else {
                mFloatingView.setImageResource(R.drawable.ic_succeed);
            }
        }
    }

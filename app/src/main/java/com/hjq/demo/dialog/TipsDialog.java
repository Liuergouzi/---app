...
public final class TipsDialog {
    ...
    public final static int ICON_FINISH = R.drawable.ic_tips_finish;
    public final static int ICON_ERROR = R.drawable.ic_tips_error;
    public final static int ICON_WARNING = R.drawable.ic_tips_warning;
